        ...
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-8 xl:gap-10">
          <Reveal>
            <div>
              ...
              <div className="mt-6 rounded-[12px] border border-slate-200 bg-white p-5 sm:p-6 transition-shadow duration-300 hover:shadow-sm">
          ...
          <Reveal delay={120}>
            <div className="overflow-hidden rounded-[12px] border border-slate-200 bg-white transition-shadow duration-300 hover:shadow-sm">
