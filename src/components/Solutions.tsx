    ...
    <section id="solucoes" className="bg-[#F7F9FC] py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-4 lg:mt-9 lg:grid-cols-12">
          {/* Featured - Ar-condicionado - spans 7 */}
          <article className="group relative overflow-hidden rounded-[12px] border border-slate-200 bg-white p-6 sm:p-6 lg:col-span-7 lg:p-7">
          ...
          {/* Climatização - spans 5 - dark */}
          <article className="relative overflow-hidden rounded-[12px] bg-brand-900 p-6 text-white sm:p-6 lg:col-span-5 lg:p-7">
          ...
          {/* Refrigeração */}
          <article className="relative overflow-hidden rounded-[12px] border border-slate-200 bg-white p-6 sm:p-6 lg:col-span-6 lg:p-7">
          ...
          <article className="relative overflow-hidden rounded-[12px] border border-slate-200 bg-slate-50 p-6 sm:p-6 lg:col-span-6 lg:p-7">
